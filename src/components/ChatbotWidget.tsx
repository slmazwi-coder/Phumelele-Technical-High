...
async function askGemini(userMessage: string): Promise<string> {
  try {
    ...
    if (!apiKey) {
      return 'The chatbot is currently being set up. Please contact the school directly at +27 84 620 6248 or principal@phumeleleths.co.za.';
    }
    ...
    return 'I\'m having trouble connecting right now. Please contact the school directly at +27 84 620 6248 or principal@phumeleleths.co.za.';
  }
}
