          ...
          <div className="flex flex-col md:flex-row gap-6 items-center justify-between">
            ...
            <div className="relative w-full md:w-64">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-school-gold/20"
                value={searchQuery}
            ...
            filteredDocs.map((doc) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-blue-50 text-school-navy rounded-xl group-hover:bg-school-navy group-hover:text-white transition-colors">
                    <FileText size={24} />
                  </div>
                  <div className="flex-grow">
                    <h3 className="font-bold text-gray-800 mb-1">{doc.name}</h3>
                    <p className="text-sm text-gray-500 mb-4">{doc.subject} · {doc.grade}</p>
                    <button
                      onClick={() => handleDownload(doc)}
                      className="flex items-center gap-2 text-school-navy font-bold hover:underline"
                    >
